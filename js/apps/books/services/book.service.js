...
// gBooks: or from localStorage, otherwise _createDefaultBooks
...
function saveBookReview(bookId, name, readAt, rate, text) {
  // const book = getBookById(bookId);
  var bookReviews = utilService.loadFromStorage('reviews of' + bookId);
    const review = {
      name,
      readAt, 
      rate,
    ...
    utilService.saveToStorage('reviews of' + bookId, bookReviews);
}

function getReviews(bookId) {
  return utilService.loadFromStorage('reviews of' + bookId);
}
...
function createBook(book) {
  var newBook = {
    ...
    thumbnail: 'www.google.ch',
    // thumbnail: book.volumeInfo.imageLinks.thumbnail,
    language: book.volumeInfo.language,
    listPrice: book.saleInfo.listPrice
    // [listPrice[currendyCode]]: book.saleInfo.listPrice.currencyCode,
