...
<div class="email-details-tool-bar flex"> 
    ...
    <button class="trash-button" @click="deleteEmail(email)">
        <i class=" far fa-trash-alt fa-2x"></i>
    </button> 
    <button class="spam-button" @click="markAsSpam(email)">
        <i class="fas fa-ban fa-2x"></i>
    </button>
    <button class="mark-as-unread-button" @click="markAsUnread(email)">
    <i class="fas fa-envelope fa-2x"></i>
    </button>
    <button class="add-email-to-notes" @click="addToNotes(email)">
        <span class="fa-stack">
